...
import DeckMaster.DeckMaster.DeckMasterFactory;
import DeckMaster.DeckMaster.DeckMasterPackage;
import DeckMaster.DeckMaster.PlainCell;
import DeckMaster.DeckMaster.PlainColumn;
...
public class DeckMasterPackageImpl extends EPackageImpl implements DeckMasterPackage {
	 ...
	 * @see DeckMaster.DeckMaster.DeckMasterPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static DeckMasterPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(DeckMaster.DeckMasterPackage.eNS_URI);
		DeckMaster.impl.DeckMasterPackageImpl theDeckMasterPackage_1 = (DeckMaster.impl.DeckMasterPackageImpl)(registeredPackage instanceof DeckMaster.impl.DeckMasterPackageImpl ? registeredPackage : DeckMaster.DeckMasterPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		DeckMaster.DeckMasterPackage theDeckMasterPackage_1 = (DeckMaster.DeckMasterPackage)EPackage.Registry.INSTANCE.getEPackage(DeckMaster.DeckMasterPackage.eNS_URI);
		...
		initEReference(getPlainDocument_Report(), theDeckMasterPackage_1.getPlainReport(), null, "report", null, 0, 1, PlainDocument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlainDocument_Section(), theDeckMasterPackage_1.getPlainSection(), null, "section", null, 0, -1, PlainDocument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPlainReport_Sections(), theDeckMasterPackage_1.getPlainSection(), theDeckMasterPackage_1.getPlainSection_PartOf(), "sections", null, 0, -1, PlainReport.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPlainSection_SubSection(), theDeckMasterPackage_1.getPlainSection(), null, "subSection", null, 0, -1, PlainSection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlainSection_Images(), theDeckMasterPackage_1.getPlainImages(), null, "images", null, 0, -1, PlainSection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlainSection_Tables(), theDeckMasterPackage_1.getPlainTable(), null, "tables", null, 0, -1, PlainSection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlainSection_PartOf(), theDeckMasterPackage_1.getPlainReport(), theDeckMasterPackage_1.getPlainReport_Sections(), "partOf", null, 0, 1, PlainSection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPlainTable_Columns(), theDeckMasterPackage_1.getPlainColumn(), null, "columns", null, 0, -1, PlainTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlainTable_Rows(), theDeckMasterPackage_1.getPlainRow(), null, "rows", null, 0, -1, PlainTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPlainRow_Cells(), theDeckMasterPackage_1.getPlainCell(), null, "cells", null, 0, -1, PlainRow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
