 ...
 * </p>
 * <ul>
 *   <li>{@link DeckMaster.impl.PlainSectionImpl#getName <em>Name</em>}</li>
 *   <li>{@link DeckMaster.impl.PlainSectionImpl#getBody <em>Body</em>}</li>
 *   <li>{@link DeckMaster.impl.PlainSectionImpl#getSubSection <em>Sub Section</em>}</li>
 *   <li>{@link DeckMaster.impl.PlainSectionImpl#getImages <em>Images</em>}</li>
 *   <li>{@link DeckMaster.impl.PlainSectionImpl#getTables <em>Tables</em>}</li>
 *   <li>{@link DeckMaster.impl.PlainSectionImpl#getPartOf <em>Part Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlainSectionImpl extends MinimalEObjectImpl.Container implements PlainSection {
	 ...
	 * @ordered
	 */
	protected EList<PlainSection> subSection;
	 ...
	 * @generated
	 */
	public EList<PlainSection> getSubSection() {
		if (subSection == null) {
			subSection = new EObjectContainmentEList<PlainSection>(PlainSection.class, this, DeckMasterPackage.PLAIN_SECTION__SUB_SECTION);
		}
		return subSection;
	}
	...
	public void setPartOf(PlainReport newPartOf) {
		if (newPartOf != partOf) {
			...
			if (partOf != null)
				msgs = ((InternalEObject)partOf).eInverseRemove(this, DeckMasterPackage.PLAIN_REPORT__SECTIONS, PlainReport.class, msgs);
			if (newPartOf != null)
				msgs = ((InternalEObject)newPartOf).eInverseAdd(this, DeckMasterPackage.PLAIN_REPORT__SECTIONS, PlainReport.class, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DeckMasterPackage.PLAIN_SECTION__SUB_SECTION:
				getSubSection().clear();
				getSubSection().addAll((Collection<? extends PlainSection>)newValue);
				return;
			case DeckMasterPackage.PLAIN_SECTION__IMAGES:
				getImages().clear();
