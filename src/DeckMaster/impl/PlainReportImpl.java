 ...
 * </p>
 * <ul>
 *   <li>{@link DeckMaster.impl.PlainReportImpl#getName <em>Name</em>}</li>
 *   <li>{@link DeckMaster.impl.PlainReportImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link DeckMaster.impl.PlainReportImpl#getIntroduction <em>Introduction</em>}</li>
 *   <li>{@link DeckMaster.impl.PlainReportImpl#getConclusion <em>Conclusion</em>}</li>
 *   <li>{@link DeckMaster.impl.PlainReportImpl#getSections <em>Sections</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlainReportImpl extends MinimalEObjectImpl.Container implements PlainReport {
	...
	public EList<PlainSection> getSections() {
		if (sections == null) {
			sections = new EObjectWithInverseResolvingEList<PlainSection>(PlainSection.class, this, DeckMasterPackage.PLAIN_REPORT__SECTIONS, DeckMasterPackage.PLAIN_SECTION__PART_OF);
		}
		return sections;
	}
